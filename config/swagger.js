...
const paths = {
  "/authenticate": {
    post: {
      ...
      responses: {
        200: jsonResponse(
          "Login response",
          ref("AuthSuccessResponse"),
          {
            success: true,
            data: {
              user: examples.user,
              token: examples.jwtToken
            },
  ...
  "/signup": {
    post: {
      ...
      requestBody: multipartRequest(ref("SignupRequest")),
      responses: {
        200: jsonResponse(
          "Signup response",
          ref("AuthSuccessResponse"),
  ...
  "/forgetpassword": {
    post: {
      ...
      requestBody: jsonRequest(ref("ForgotPasswordRequest"), {
        forgetpass_email: "ateek@example.com"
      }),
      responses: {
        200: jsonResponse(
          "Password reset token response",
          ref("SimpleUserResponse"),
          {
            success: true,
            data: {
              user: {
                ...examples.user,
                resetPasswordKey: "JH8K2mQ"
              }
            }
          }
        ),
  ...
  "/googlelogin": {
    post: {
      ...
      requestBody: jsonRequest(ref("GoogleLoginRequest"), {
  ...
  "/facebooklogin": {
    post: {
      tags: ["Authentication"],
      summary: "Authenticate or register with Facebook",
      requestBody: jsonRequest(ref("FacebookLoginRequest"), {
        userID: "1029384756",
...
module.exports = {
  ...
  tags: [
    { name: "Authentication", description: "Login, signup, password reset, and social authentication endpoints." },
  ...
  components: {
    ...
    schemas: {
      ...
      ForgotPasswordRequest: {
        type: "object",
        required: ["forgetpass_email"],
        properties: {
          forgetpass_email: { type: "string", format: "email" }
        }
      },
      ResetPasswordRequest: {
        type: "object",
        required: ["new_password", "confirm_password", "reset_token"],
        properties: {
      ...
      FacebookLoginRequest: {
        type: "object",
        required: ["userID", "accessToken", "source"],
        properties: {
          userID: { type: "string" },
